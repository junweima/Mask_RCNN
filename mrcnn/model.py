...
def compute_backbone_shapes(config, image_shape):
    ...
    assert config.BACKBONE in ["resnet50", "resnet101", "mbv1", "mbv2"]
    return np.array(
...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        elif config.BACKBONE == 'mbv1':
            _, C2, C3, C4, C5 = mobilenet_graph(input_image, config.BACKBONE,
                                             alpha=1.0, train_bn=config.TRAIN_BN)
        elif config.BACKBONE == 'mbv2':
            raise ValueError('TODO: feature is still under construction')
        else:
            raise ValueError()
    ...
    def get_imagenet_weights(self):
        ...
        if self.config.BACKBONE == 'resnet50':
        ...
        elif self.config.BACKBONE == 'mbv1':
            TF_WEIGHTS_PATH_NO_TOP = 'https://github.com/fchollet/deep-learning-models/'\
            ...
            raise ValueError('JM: not sure how to get weights for this one...')
